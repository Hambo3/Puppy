...
var Sources ={
    ...
    walk1:function(){
        return[
            3,[11,15,10,9,13,-3,16,-9,15,5],3,[10,9,1,7,5,-8,14,-6],3,[10,9,10,14,2,12,1,7],8,[25,-13],8,[11,2,21,-21,21,-40,11,-17],7,[11,2,-21,-5,-21,-24,11,-17],9,[11,-17,-21,-24,-9,-47,21,-40]
        ];
    },
    walk2:function(){
        return[
            3,[17,-1,16,-3,13,-3,16,-9,20,-8],3,[16,-3,17,0,12,-1,13,-3],8,[25,-13],8,[11,2,21,-21,21,-40,11,-17],7,[11,2,-21,-5,-21,-24,11,-17],9,[11,-17,-21,-24,-9,-47,21,-40]
        ];
    }
}
...
var Factory = {
    ...
    Gran1: function(a){
        ...
        var arm = [
            [
                {col:"#F3BFCB",pt:[{x:-20,y:-29},{x:-15,y:-31},{x:-9,y:-28},{x:-14,y:-26}]},
                {col:"#ffac6c",pt:[{x:-9,y:-9},{x:-9,y:-28},{x:-14,y:-26},{x:-14,y:-7}]},
                {col:"#ef7e52",pt:[{x:-14,y:-7},{x:-14,y:-26},{x:-20,y:-29},{x:-20,y:-10}]},
                {col:"#C198B6",pt:[{x:-20,y:-29},{x:-14,y:-26},{x:-14,y:-19},{x:-20,y:-22}]},
                {col:"#C198B6",pt:[{x:-14,y:-19},{x:-14,y:-26},{x:-9,y:-28},{x:-9,y:-21}]}
            ],
            [
                {col:"#F3BFCB",pt:[{x:-16,y:-28},{x:-11,y:-30},{x:-5,y:-27},{x:-10,y:-25}]},
                {col:"#ffac6c",pt:[{x:0,y:-24},{x:-5,y:-27},{x:-10,y:-25},{x:-5,y:-22}]},
                {col:"#ef7e52",pt:[{x:-5,y:-22},{x:-9,y:-24},{x:-9,y:-19},{x:-5,y:-17}]},
                {col:"#b188b6",pt:[{x:-16,y:-28},{x:-9,y:-25},{x:-9,y:-19},{x:-16,y:-22}]},
                {col:"#ffac6c",pt:[{x:-5,y:-22},{x:8,y:-28},{x:13,y:-26},{x:0,y:-20}]},
                {col:"#ef7e52",pt:[{x:12,y:-26},{x:12,y:-21},{x:0,y:-15},{x:-5,y:-17},{x:-5,y:-22},{x:0,y:-20}]},
                {col:"#ffac6c",pt:[{x:12,y:-26},{x:8,y:-28},{x:22,y:-35},{x:22,y:-37},{x:28,y:-34}]},
                {col:"#ef7e52",pt:[{x:28,y:-34},{x:28,y:-29},{x:12,y:-21},{x:12,y:-26}]}
            ]                
            ];
       ...
       {col:"#3d3435",pt:[{x:-3,y:2},{x:-11,y:-2},{x:-11,y:3},{x:-3,y:7}]},
       {col:"#938f8e",pt:[{x:-11,y:-2},{x:-5,y:-5},{x:3,y:-1},{x:-3,y:2}]},
       {col:"#ef7e52",pt:[{x:0,y:-7},{x:5,y:-5},{x:5,y:-9}]},
       {col:"#ffac6c",pt:[{x:5,y:-5},{x:10,y:-8},{x:10,y:-12},{x:5,y:-9}]},
       {col:"#ef7e52",pt:[{x:-11,y:-2},{x:-11,y:-12},{x:-5,y:-9},{x:-5,y:1}]},
       {col:"#ffac6c",pt:[{x:-5,y:1},{x:-5,y:-8},{x:0,y:-10},{x:0,y:-2}]},
       {col:"#C198B6",pt:[{x:-22,y:-16},{x:-22,y:-38},{x:0,y:-27},{x:0,y:-5}]},
       {col:"#F3BFCB",pt:[{x:0,y:-5},{x:0,y:-27},{x:22,y:-38},{x:22,y:-16}]},
       {col:"#ef7e52",pt:[{x:-22,y:-38},{x:-22,y:-60},{x:0,y:-49},{x:0,y:-27}]},
       {col:"#ffac6c",pt:[{x:0,y:-27},{x:0,y:-49},{x:22,y:-60},{x:22,y:-38}]},
       {col:"#dddddd",pt:[{x:-22,y:-60},{x:0,y:-71},{x:22,y:-60},{x:0,y:-49}]},
       {col:"#cccccc",pt:[{x:-22,y:-60},{x:0,y:-49},{x:-16,y:-38},{x:-22,y:-41}]},
       {col:"#880000",pt:[{x:5,y:-34},{x:18,y:-40},{x:18,y:-38},{x:16,y:-37},{x:16,y:-38},{x:8,y:-34},{x:8,y:-33},{x:5,y:-32}]},
       {col:"#333333",pt:[{x:1,y:-44},{x:10,y:-48},{x:10,y:-38},{x:1,y:-34}]},
       {col:"#333333",pt:[{x:13,y:-39},{x:13,y:-49},{x:21,y:-53},{x:21,y:-43}]},
       {col:"#333333",pt:[{x:8,y:-45},{x:13,y:-47},{x:13,y:-44},{x:9,y:-42}]},
       {col:"#ffac6c",pt:[{x:2,y:-43},{x:9,y:-46},{x:9,y:-39},{x:2,y:-36}]},
       {col:"#ffac6c",pt:[{x:14,y:-41},{x:14,y:-48},{x:20,y:-51},{x:20,y:-44}]},
       {col:"#000000",pt:[{x:3,y:-41},{x:7,y:-42},{x:7,y:-40},{x:3,y:-39}]},
       {col:"#000000",pt:[{x:15,y:-46},{x:18,y:-47},{x:18,y:-45},{x:15,y:-44}]}
    ];
        for(var i=0;i<arm[a].length;i++){
            b.push(arm[a][i]);
        }
       
       return Util.Scale(b,0.8);
    },
    Gran2: function(a){
        a = a || 0;
        var arm = [
            [
                {col:"#C198B6",pt:[{x:9,y:-27},{x:15,y:-30},{x:21,y:-27},{x:15,y:-24}]},
                {col:"#ffac6c",pt:[{x:21,y:-8},{x:20,y:-26},{x:15,y:-24},{x:15,y:-5}]},
                {col:"#ef7e52",pt:[{x:15,y:-5},{x:15,y:-24},{x:9,y:-27},{x:9,y:-8}]},
                {col:"#C198B6",pt:[{x:9,y:-27},{x:15,y:-24},{x:15,y:-17},{x:9,y:-20}]},
                {col:"#C198B6",pt:[{x:15,y:-17},{x:15,y:-24},{x:21,y:-27},{x:21,y:-19}]}                
            ],
            [
                {col:"#C198B6",pt:[{x:9,y:-27},{x:15,y:-30},{x:21,y:-27},{x:15,y:-24}]},
                {col:"#ffac6c",pt:[{x:22,y:-37},{x:22,y:-33},{x:15,y:-30},{x:21,y:-27},{x:34,y:-33}]},
                {col:"#ef7e52",pt:[{x:33,y:-33},{x:15,y:-24},{x:14,y:-17},{x:33,y:-26}]},
                {col:"#C198B6",pt:[{x:9,y:-27},{x:15,y:-24},{x:15,y:-17},{x:9,y:-20}]},
                {col:"#C198B6",pt:[{x:15,y:-17},{x:15,y:-24},{x:21,y:-27},{x:21,y:-19}]}                
            ]                
            ];
        var b = [
            {col:"#3d3435",pt:[{x:-7,y:1},{x:-7,y:-4},{x:4,y:-9},{x:4,y:-4}]},
            {col:"#3d3435",pt:[{x:-7,y:-4},{x:-13,y:-7},{x:-13,y:-2},{x:-7,y:1}]},
            {col:"#ef7e52",pt:[{x:-2,y:-6},{x:-2,y:-19},{x:-7,y:-17},{x:-7,y:-4}]},
            {col:"#ffac6c",pt:[{x:-7,y:-4},{x:-7,y:-17},{x:-13,y:-20},{x:-13,y:-7}]},
            {col:"#938f8e",pt:[{x:3,y:1},{x:-3,y:-2},{x:8,y:-7},{x:14,y:-4}]},
            {col:"#645b5c",pt:[{x:3,y:6},{x:3,y:1},{x:14,y:-4},{x:14,y:1}]},
            {col:"#3d3435",pt:[{x:3,y:1},{x:-3,y:-2},{x:-3,y:3},{x:3,y:6}]},
            {col:"#ffac6c",pt:[{x:8,y:-1},{x:8,y:-14},{x:3,y:-12},{x:3,y:1}]},
            {col:"#ef7e52",pt:[{x:3,y:1},{x:3,y:-12},{x:-3,y:-15},{x:-3,y:-2}]},
            {col:"#C198B6",pt:[{x:-22,y:-16},{x:-22,y:-38},{x:0,y:-27},{x:0,y:-5}]},
            {col:"#F3BFCB",pt:[{x:0,y:-5},{x:0,y:-27},{x:22,y:-38},{x:22,y:-16}]},
            {col:"#ef7e52",pt:[{x:-22,y:-38},{x:-22,y:-60},{x:0,y:-49},{x:0,y:-27}]},
            {col:"#ffac6c",pt:[{x:0,y:-27},{x:0,y:-49},{x:22,y:-60},{x:22,y:-38}]},
            {col:"#dddddd",pt:[{x:-22,y:-60},{x:0,y:-71},{x:22,y:-60},{x:0,y:-49}]},
            {col:"#cccccc",pt:[{x:-22,y:-60},{x:0,y:-49},{x:0,y:-30},{x:-22,y:-41}]},
            {col:"#bbbbbb",pt:[{x:0,y:-30},{x:0,y:-49},{x:22,y:-60},{x:11,y:-36}]},
            {col:"#bbbbbb",pt:[{x:-21,y:-37},{x:-21,y:-45},{x:-13,y:-41},{x:-13,y:-33},{x:-13,y:-33}]},
            {col:"#dddddd",pt:[{x:-13,y:-33},{x:-13,y:-41},{x:-8,y:-43},{x:-8,y:-35}]},
            {col:"#aaaaaa",pt:[{x:-21,y:-45},{x:-16,y:-47},{x:-8,y:-43},{x:-13,y:-41}]}
            ];
            for(var i=0;i<arm[a].length;i++){
                b.push(arm[a][i]);
            }
